...
import es.luispedraza.sunshine.data.WeatherContract.LocationEntry;
import es.luispedraza.sunshine.data.WeatherContract.WeatherEntry;
import es.luispedraza.sunshine.data.WeatherDBHelper;
...
public class TestDB extends AndroidTestCase {
    ...
    public void testInsertReadDb() {
        ...
        // Data's inserted IN THEORY.  Now pull some out to stare at it and verify the values
        ...
        weatherValues.put(WeatherEntry.COLUMN_WIND_DEG, 1.1);
        ...
        assertEquals(weatherCursor.getDouble(
                weatherCursor.getColumnIndex(WeatherEntry.COLUMN_WIND_DEG)), 1.1);
        assertEquals(weatherCursor.getDouble(
        ...
        assertEquals(weatherCursor.getString(
                weatherCursor.getColumnIndex(WeatherEntry.COLUMN_SHORT_DESCRIPTION)), "Asteroids");
        assertEquals(weatherCursor.getDouble(
