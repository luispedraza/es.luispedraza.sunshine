...
public class WeatherDBHelper extends SQLiteOpenHelper {
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        // This method is invoqued when DB version changes.
        // As we are using DB as a simple data cache, it's safe to simply recreate the tables:
